    ...
    >
      <MDBContainer className="p-4 fluid">
        <MDBRow>
          ...
          <MDBCol lg="3" md="6" className="mx-4 mb-4 mb-md-0">
            <div>
              <h5 className="text-uppercase">Location</h5>
              <p>
                Located on the top level of the new Raine Square redevelopment,
          ...
          <MDBCol lg="3" md="6" className="mx-4 mb-4 mb-md-0">
            <div>
              <h5 className="text-uppercase">Parking</h5>
              <p>
                Park directly under the Cinema with Wilson Parking Raine Square!
              </p>
            </div>
          </MDBCol>
