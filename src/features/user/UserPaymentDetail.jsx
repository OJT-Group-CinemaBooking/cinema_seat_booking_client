...
const UserPaymentDetail = ({ userPayment }) => {
  ...
  return (
    <Col className="m-3 mt-5 mx-auto" md={6}>
      ...
      >
        ...
        {
          edit? 
          <UserPaymentForm userPayment={userPayment} handleEdit={handleEdit} /> : 
          <UserPaymentDetailInfo userPayment={userPayment} toggle={toggle} />
        }
