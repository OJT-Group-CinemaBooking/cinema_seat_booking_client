...
const UserDetail = () => {
  ...
  const canLogin = [ firstname,lastname,email,canRequest ].every(Boolean)
    ...
    <Col className="m-3 mx-auto" md={5}>
      <Card style={{ borderRadius: "20%" }}>
        <Card.Img
          ...
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUFJ4m3HGM8397IWhGhLphaU38QtqrcYQoUg&usqp=CAU"
          alt="avatar"
        />
        <div className={classes.info}>
          ...
          <div className={classes.userForm_button}>
          <Button type="submit" variant="success">Change</Button>
          <Button type="button" onClick={onEditHandle} variant="danger">Cancel</Button>
          </div>
          </Form>
          }
